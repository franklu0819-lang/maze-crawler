...
Team reward: delta_total_energy/1000 + delta_units*W + delta_gap + 0.01 + terminal.
"""
...
def train(num_iter=200, batch=50, lr=0.0003, version=None):
    ...
    print(f"  Reward: delta_e/1000 + delta_units*{UNIT_WEIGHT} + delta_gap + 0.01 + terminal +10/-1")
