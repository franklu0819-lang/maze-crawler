"""Train factory policy with BC + PPO + Mixed Fixed Opponents.

Phase 1: BC — collect expert data from agent_v2, supervised pre-training.
Phase 2: PPO against mixed opponents: 50% v3 + 30% v5 + 20% random.
"""
...
def train(num_iter=200, batch=50, lr=0.0003, version=None,
    ...
    print(f"=== Train v{version} (BC+PPO vs 50%v3+30%v5+20%rand) ===")
