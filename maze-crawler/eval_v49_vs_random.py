"""Eval: v49 (all-unit NN) vs random agent, 500 games."""
import sys, os
...
model49.eval()
print("Loaded v49 best weights", flush=True)
...
print(f"\n=== v49 vs random: {wins}W-{losses}L-{draws}D ({wins/NUM_GAMES*100:.1f}%) ===", flush=True)
